 ...
 */
function thirdwing_breadcrumb($variables) {
 ...
 */
function thirdwing_preprocess_maintenance_page(&$variables) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // thirdwing_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  thirdwing_preprocess_html($variables);
}
...
function thirdwing_preprocess_html(&$variables) {
  ...
  if (theme_get_setting('thirdwing_width') == 'fluid') {
 ...
 * Override or insert variables into the html template.
 */
function thirdwing_process_html(&$variables) {
 ...
 * Override or insert variables into the page template.
 */
function thirdwing_process_page(&$variables) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function thirdwing_preprocess_region(&$variables) {
